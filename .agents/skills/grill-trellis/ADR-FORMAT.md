...
ADRs live in `.trellis/spec/adr/` and use sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.

Create the `.trellis/spec/adr/` directory lazily — only when the first ADR is needed.
...
Scan `.trellis/spec/adr/` for the highest existing number and increment by one.
